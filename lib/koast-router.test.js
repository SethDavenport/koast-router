...
/* the koast-router is now in it's own npm package and can no longer reference a local copy of log module
...
describe('koast router', function () {
  ...
  it('should have a mounted route available', function (done) {
    ...
    var router = koastRouter(basicRoute, null, null, getDummyLogger());
    var app = express();
  ...
  it('should handle a middleware factory, use get', function (done) {
    ...
    var router = koastRouter(middlewareFactoryRoute, null, null, getDummyLogger());
    var app = express();
