...
var log = null; // log gets passed in as an argument now
 ...
 */
module.exports =
  function koastRouter(routes, options, router, loggerIn) {
    log = loggerIn; // log module is in koast, koast-router is now it's own module so we take a logger as an argument
    options = options || {};
